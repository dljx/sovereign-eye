      ...
      {open && (
        <div className="ev-grid">
          ...
          <div>
            ...
            <EvRow k="NTM / LT PEG" v={ratios.fwd_peg != null || ratios.peg_lt != null ? `${n(ratios.fwd_peg, 2) ?? '·'} / ${n(ratios.peg_lt, 2) ?? '·'}` : null} title="NTM = Fwd P/E ÷ next-year EPS growth (1-year PEG — a rebound year off a low base compresses it without implying durable cheapness). LT = Fwd P/E ÷ FY+1→FY+2/3 consensus EPS CAGR, known basis (FMP, then Alpha Vantage fallback — blank only if both miss). NTM cheap while LT ordinary = one-year-deep cheapness (v4, 2026-07-13)" />
